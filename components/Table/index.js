      ...
      <div className="my-12 border rounded-lg md:w-full lg:w-9/12 sm:w-full mx-auto ">
        <div className="mt-3 px-6">
          ...
          <div className="mt-8 flex  justify-between items-center">
            <p className=" max-w-2xl text-sm  text-gray-500">{data.logo}</p>
            <p className="  max-w-2xl text-sm  text-gray-500">{data.desc}</p>
            {data.img && (
              <Image
            ...
            {data.text && (
              <p className=" max-w-2xl text-sm  text-gray-500">{data.text}</p>
            )}
          </div>
        </div>
              ...
              return (
                ...
                >
                  ...
                  <dd className="mt-1 flex text-sm text-gray-900 sm:col-span-2 sm:mt-0">
                    <span className="flex-grow  ">{currElem.value}</span>
